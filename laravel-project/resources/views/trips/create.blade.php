...
<div class="py-3 my-3">
    <label for="destitnationInput" class="form-label"><h3><strong>Where are you going?</strong></h3></label>
...
<a href="{{route('trips.index')}}"><button class="btn btn-primary">Add Trip</button>
</a>
